<template>
     <section id="Skills">
          ...
          <article>
            <div>
             <h3 class="subititle">Principais Habilidades</h3>
             <p>Tecnologias que me ajudam a superar os desafios do dia a dia</p>
             <div class="row w-25">
                ...
                <div class="mini-card col-md-3 m-2">
                    <figure class="my-auto pt-2 pb-2">
                      <img src="/images/bootstrap-svgrepo-com.svg" alt="Bootstrap logo" width="30">                      
                    </figure>
               </div>
                <div class="mini-card col-md-3 m-2">
                    <figure class="my-auto pt-2 pb-2">
